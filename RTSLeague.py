...
class privateLeague():
    ...
    def __init__(self, config):
        ...
        datadirectory = 'cached-rankings-data'
        self.league_id = LID
        ...
        print(self.Rosters)
        self.Rankings = rankings.getROSECR(self.FPKey, datadirectory)
        ...
        self.Players = pd.merge(self.Players,rankings.getWeeklyECR(self.FPKey,datadirectory,self.CurrentWeek),how='outer',on='Player')
